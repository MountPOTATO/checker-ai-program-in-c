...
int depth;													//alpha_beta剪枝深度
int board[BOARD_SIZE][BOARD_SIZE] = { 0 };					//全局棋盘
int temp_map[BOARD_SIZE][BOARD_SIZE] = { 0 };				//暂时生成的棋局
int me_flag;												//我方：1为黑，2为白
int other_flag;												//敌方：1为黑，2为白
